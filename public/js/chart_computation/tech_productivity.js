$(document).ready(function() {
    ...
    // Tech Productivity Start
    $("#tech_productivity_filter").change(function() {
    ...
    $("#tech_productivity_filter2").change(function() {
        ...
        gapi.client.sheets.spreadsheets.values.get({
          ...
          const values = response.result.values;
            ...
            if (side == "left") {
                ...
                create_charts_tech_productivity_filter_left(values);
            } else if (side == "right") {
                // create_charts_tech_productivity_right(values);
                create_charts_tech_productivity_filter_right(values);
            } else {
    ...
    function create_charts_tech_productivity_filter_left(records) {
        var date_filter = $("#tech_productivity_filter").val().split('to');
    ...
    function create_charts_tech_productivity_filter_right(records) {
        var date_filter = $("#tech_productivity_filter2").val().split('to');
